...
TAGMES = [ " **❅ बेबी कहा हो। 🤗** ",
           ...
           " **❅ ये attitude किसे @ceo_of_secularism दिखा रहे हो 😮** ",
           " **❅ हेमलो कहा busy ho 👀** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("๏ Mᴇɴᴛɪᴏɴ Pʀᴏᴄᴇꜱꜱ Sᴛᴏᴘᴘᴇᴅ ||PᴀPᴀ|| Tᴏ ||@ceo_of_secularism||๏")
