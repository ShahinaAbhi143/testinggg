...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐇𝐞𝐥𝐥𝐨 𝐉𝐢 𝐍𝐚𝐦𝐚𝐬𝐭𝐞😛** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐁𝐚𝐛𝐲 𝐊𝐤𝐫𝐡..?🤔** ",
           " **𝐃𝐨 𝐘𝐨𝐮 𝐊𝐧𝐨𝐰 𝐖𝐡𝐨 𝐈𝐬 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [@ceo_of_secularism].?** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("🌷 AʙʜɪXᴍᴜꜱɪᴄ Tᴀɢ Aʟʟ Pʀᴏᴄᴇꜱꜱ Sᴛᴏᴘᴘᴇᴅ Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@ceo_of_secularism|| 🎉")
